...
class CafeForm(FlaskForm):
    ...
    closes = StringField('Closing Time e.g.10PM', validators=[DataRequired()])
...
def add_cafe():
    ...
    if form.validate_on_submit():
        with open('cafe-data.csv', 'a', newline='', encoding="utf8") as csv_file:
            csv_file.writelines(f"\n{form.cafe.data},{form.location.data},{form.opens.data},{form.closes.data},{form.coffee_rating.data},{form.wifi_rating.data},{form.power_rating.data}")
